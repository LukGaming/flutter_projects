  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Todo: obx_int.EntityDefinition<Todo>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = Todo(
              id: idParam, name: nameParam, body: bodyParam, done: doneParam);
...
class Todo_ {
  ...
  /// See [Todo.name].
  static final name = obx.QueryStringProperty<Todo>(_entities[0].properties[1]);

  /// See [Todo.body].
  static final body = obx.QueryStringProperty<Todo>(_entities[0].properties[2]);
